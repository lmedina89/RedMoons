...
assert.equal(GAME_VERSION, '0.1.4.4.1', 'Warfront Strongholds/Outposts/Environmental Detail version must be v0.1.4.4.1');
assert.ok(html.includes('v0.1.4.4.1'), 'Build shell must identify v0.1.4.4.1');
