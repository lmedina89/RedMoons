...
assert.equal(GAME_VERSION, '0.1.4.4.3', 'Lailani Field Test version must be v0.1.4.4.3');
assert.ok(html.includes('v0.1.4.4.3'), 'Build shell must identify v0.1.4.4.3');
