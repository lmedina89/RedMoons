...
assert.equal(GAME_VERSION, '0.1.4.4.5.2', 'Zerakoth Field Test version must be v0.1.4.4.5.2');
assert.ok(html.includes('v0.1.4.4.5.2'), 'Build shell must identify v0.1.4.4.5.2');
