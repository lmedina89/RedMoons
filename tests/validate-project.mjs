...
assert.equal(GAME_VERSION, '0.1.4.4.4', 'El’exis Field Test version must be v0.1.4.4.4');
assert.ok(html.includes('v0.1.4.4.4'), 'Build shell must identify v0.1.4.4.4');
