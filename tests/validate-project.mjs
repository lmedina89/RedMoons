...
assert.equal(GAME_VERSION, '0.1.4.4.0', 'Warfront Geography & Atmosphere Foundation version must be v0.1.4.4.0');
assert.ok(html.includes('v0.1.4.4.0'), 'Build shell must identify v0.1.4.4.0');
