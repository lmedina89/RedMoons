...
assert.equal(GAME_VERSION, '0.1.3.2.1.1', 'Hotfix version must be v0.1.3.2.1.1');
assert.ok(html.includes('v0.1.3.2.1.1'), 'Build shell must identify v0.1.3.2.1.1');
...
assert.ok(cssSource.includes('width: 338px; height: 205px') && cssSource.includes('#interact-button { position: absolute; right: 170px; bottom: 0;') && cssSource.includes('.recovery-cluster { position: absolute; right: 164px; bottom: 136px;'), 'Combat controls must use the corrected right-biased geometry so Use/recovery stay out of the center combat lane');
...
assert.ok(!worldSource.includes('releaseAssetsNotNeededForMap('), 'v0.1.3.2.1.1 must not eagerly evict textures during the WebKit-sensitive Scene handoff');
