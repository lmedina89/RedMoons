...
assert.equal(GAME_VERSION, '0.1.4.2.1', 'Refuge geometry hotfix version must be v0.1.4.2.1');
assert.ok(html.includes('v0.1.4.2.1'), 'Build shell must identify v0.1.4.2.1');
