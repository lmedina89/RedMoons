...
export const ITEM_DEFS = Object.freeze({
  ...
  chest_wayfarer: { id: 'chest_wayfarer', name: 'Wayfarer Shirt', slot: 'chest', tags: ['armor', 'cloth', 'npc_loadout', 'player_ready', 'starter'], levelReq: 1, requirements: {}, baseStats: { defense: 1 }, visual: 'chest_wayfarer', value: 5, playerEquipReady: true, npcOnly: false, animationClass: 'slash_fallback' },
  ...
  legs_ash_pants: { id: 'legs_ash_pants', name: 'Ashcloth Trousers', slot: 'legs', tags: ['armor', 'cloth', 'npc_loadout', 'player_ready', 'starter'], levelReq: 1, requirements: {}, baseStats: { defense: 1 }, visual: 'legs_ash', value: 5, playerEquipReady: true, npcOnly: false, animationClass: 'slash_fallback' },
  ...
  hands_hide_wraps: { id: 'hands_hide_wraps', name: 'Hide Handwraps', slot: 'hands', tags: ['armor', 'leather', 'npc_loadout', 'player_ready', 'starter'], levelReq: 1, requirements: {}, baseStats: { defense: 1 }, visual: 'hands_hide', value: 5, playerEquipReady: true, npcOnly: false, animationClass: 'slash_fallback' },
  ...
  feet_road_boots: { id: 'feet_road_boots', name: 'Road Boots', slot: 'feet', tags: ['armor', 'leather', 'npc_loadout', 'player_ready', 'starter'], levelReq: 1, requirements: {}, baseStats: { defense: 1 }, visual: 'feet_road', value: 5, playerEquipReady: true, npcOnly: false, animationClass: 'slash_fallback' },
