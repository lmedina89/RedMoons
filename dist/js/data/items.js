...
export const ITEM_DEFS = Object.freeze({
  ...
  head_iron_revised: { id: 'head_iron_revised', name: 'Iron War Helm', slot: 'head', tags: ['armor', 'metal', 'revised_combat'], levelReq: 4, requirements: { str: 9 }, baseStats: { defense: 4 }, visual: 'head_iron_revised', value: 58, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  ...
  shoulders_legion: { id: 'shoulders_legion', name: 'Legion Pauldrons', slot: 'shoulders', tags: ['armor', 'metal', 'npc_loadout'], levelReq: 4, requirements: { str: 9 }, baseStats: { defense: 3, str: 1 }, visual: 'shoulders_legion', value: 52, playerEquipReady: false, npcOnly: true, animationClass: 'npc_only' },
  shoulders_leather_revised: { id: 'shoulders_leather_revised', name: 'Ashhide Shoulders', slot: 'shoulders', tags: ['armor', 'leather', 'player_ready'], levelReq: 2, requirements: { dex: 7 }, baseStats: { defense: 2 }, visual: 'shoulders_leather_revised', value: 28, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  ...
  chest_legion: { id: 'chest_legion', name: 'Legion Cuirass', slot: 'chest', tags: ['armor', 'metal', 'revised_combat'], levelReq: 5, requirements: { str: 11 }, baseStats: { defense: 7, maxHp: 12 }, visual: 'chest_legion', value: 92, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  ...
  chest_steel_plate: { id: 'chest_steel_plate', name: 'Steel Bastion Plate', slot: 'chest', tags: ['armor', 'metal', 'player_ready', 'material_steel'], levelReq: 6, requirements: { str: 13 }, baseStats: { defense: 9, maxHp: 16 }, visual: 'chest_steel_plate', value: 128, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  ...
  legs_iron_greaves: { id: 'legs_iron_greaves', name: 'Iron Greaves', slot: 'legs', tags: ['armor', 'metal', 'npc_loadout'], levelReq: 4, requirements: { str: 9 }, baseStats: { defense: 4 }, visual: 'legs_plate', value: 42, playerEquipReady: false, npcOnly: true, animationClass: 'npc_only' },
  ...
  hands_legion: { id: 'hands_legion', name: 'Legion Gloves', slot: 'hands', tags: ['armor', 'metal', 'revised_combat'], levelReq: 4, requirements: { str: 9 }, baseStats: { defense: 3, attack: 1 }, visual: 'hands_legion', value: 48, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  ...
  feet_revised: { id: 'feet_revised', name: 'Legion Boots', slot: 'feet', tags: ['armor', 'metal', 'npc_loadout'], levelReq: 4, requirements: { str: 8 }, baseStats: { defense: 3, dex: 1 }, visual: 'feet_revised', value: 46, playerEquipReady: false, npcOnly: true, animationClass: 'npc_only' },
  feet_leather_revised: { id: 'feet_leather_revised', name: 'Ashrunner Leather Boots', slot: 'feet', tags: ['armor', 'leather', 'player_ready'], levelReq: 2, requirements: { dex: 7 }, baseStats: { defense: 1, dex: 1 }, visual: 'feet_leather_revised', value: 28, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
