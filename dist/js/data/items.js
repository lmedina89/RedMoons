...
export const ITEM_DEFS = Object.freeze({
  ...
  weapon_bronze_arming_sword: { id: 'weapon_bronze_arming_sword', name: 'Bronze Arming Sword', slot: 'weapon', tags: ['weapon', 'sword', 'player_ready', 'material_bronze'], levelReq: 3, requirements: { str: 8 }, baseStats: { attack: 6 }, visual: 'weapon_bronze_arming_sword', value: 42, combatProfile: 'sword_four_hit', playerCombatReady: true, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  weapon_copper_arming_sword: { id: 'weapon_copper_arming_sword', name: 'Copper Arming Sword', slot: 'weapon', tags: ['weapon', 'sword', 'player_ready', 'material_copper'], levelReq: 2, requirements: { str: 7 }, baseStats: { attack: 5 }, visual: 'weapon_copper_arming_sword', value: 32, combatProfile: 'sword_four_hit', playerCombatReady: true, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  weapon_steel_arming_sword: { id: 'weapon_steel_arming_sword', name: 'Steel Arming Sword', slot: 'weapon', tags: ['weapon', 'sword', 'player_ready', 'material_steel'], levelReq: 5, requirements: { str: 10 }, baseStats: { attack: 8 }, visual: 'weapon_steel_arming_sword', value: 76, combatProfile: 'sword_four_hit', playerCombatReady: true, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  weapon_ceramic_arming_sword: { id: 'weapon_ceramic_arming_sword', name: 'Ceramic Arming Sword', slot: 'weapon', tags: ['weapon', 'sword', 'player_ready', 'material_ceramic'], levelReq: 6, requirements: { str: 10, dex: 9 }, baseStats: { attack: 9 }, visual: 'weapon_ceramic_arming_sword', value: 94, combatProfile: 'sword_four_hit', playerCombatReady: true, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  weapon_gold_arming_sword: { id: 'weapon_gold_arming_sword', name: 'Gilded Arming Sword', slot: 'weapon', tags: ['weapon', 'sword', 'player_ready', 'material_gold'], levelReq: 7, requirements: { str: 11 }, baseStats: { attack: 10 }, visual: 'weapon_gold_arming_sword', value: 130, combatProfile: 'sword_four_hit', playerCombatReady: true, playerEquipReady: true, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  ...
  weapon_pitsteel_sword_npc: { id: 'weapon_pitsteel_sword_npc', name: 'Pitsteel Longsword', slot: 'weapon', tags: ['weapon', 'sword', 'npc_loadout', 'infernal'], levelReq: 30, requirements: {}, baseStats: { attack: 18 }, visual: 'weapon_pitsteel_sword', value: 0, combatProfile: 'single_slash', playerCombatReady: false, playerEquipReady: false, animationClass: 'npc_only', npcOnly: true },
  armor_zerakoth_warplate_npc: { id: 'armor_zerakoth_warplate_npc', name: "Warden's Warplate", slot: 'chest', tags: ['armor', 'npc_loadout', 'infernal', 'commander', 'zerakoth'], levelReq: 60, requirements: {}, baseStats: { defense: 30 }, visual: 'zerakoth_warplate', value: 0, playerCombatReady: false, playerEquipReady: false, animationClass: 'npc_only', npcOnly: true },
  weapon_wardens_hellblade_npc: { id: 'weapon_wardens_hellblade_npc', name: "Warden's Hellblade", slot: 'weapon', tags: ['weapon', 'sword', 'npc_loadout', 'infernal', 'commander', 'zerakoth'], levelReq: 60, requirements: {}, baseStats: { attack: 34 }, visual: 'weapon_wardens_hellblade', value: 0, combatProfile: 'single_slash', playerCombatReady: false, playerEquipReady: false, animationClass: 'npc_only', npcOnly: true },
  weapon_bone_spear_npc: { id: 'weapon_bone_spear_npc', name: 'Bone Pike', slot: 'weapon', tags: ['weapon', 'spear', 'npc_loadout'], levelReq: 1, requirements: {}, baseStats: { attack: 5 }, visual: 'weapon_bone_spear', value: 20, playerCombatReady: false, playerEquipReady: false, animationClass: 'npc_only', npcOnly: true },
  weapon_bone_bow_npc: { id: 'weapon_bone_bow_npc', name: 'Bonewood Bow', slot: 'weapon', tags: ['weapon', 'bow', 'npc_loadout'], levelReq: 1, requirements: {}, baseStats: { attack: 4 }, visual: 'weapon_bone_bow', value: 18, playerCombatReady: false, playerEquipReady: false, animationClass: 'npc_only', npcOnly: true },
  ...
  chest_wayfarer: { id: 'chest_wayfarer', name: 'Wayfarer Shirt', slot: 'chest', tags: ['armor', 'cloth', 'npc_loadout', 'player_ready', 'starter'], levelReq: 1, requirements: {}, baseStats: { defense: 1 }, visual: 'chest_wayfarer', playerVisual: 'chest_starter_revised', value: 5, playerEquipReady: true, npcOnly: false, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  ...
  legs_ash_pants: { id: 'legs_ash_pants', name: 'Ashcloth Trousers', slot: 'legs', tags: ['armor', 'cloth', 'npc_loadout', 'player_ready', 'starter'], levelReq: 1, requirements: {}, baseStats: { defense: 1 }, visual: 'legs_ash', playerVisual: 'legs_starter_revised', value: 5, playerEquipReady: true, npcOnly: false, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  ...
  hands_hide_wraps: { id: 'hands_hide_wraps', name: 'Hide Handwraps', slot: 'hands', tags: ['armor', 'leather', 'npc_loadout', 'player_ready', 'starter'], levelReq: 1, requirements: {}, baseStats: { defense: 1 }, visual: 'hands_hide', playerVisual: 'hands_starter_revised', value: 5, playerEquipReady: true, npcOnly: false, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
  ...
  feet_road_boots: { id: 'feet_road_boots', name: 'Road Boots', slot: 'feet', tags: ['armor', 'leather', 'npc_loadout', 'player_ready', 'starter'], levelReq: 1, requirements: {}, baseStats: { defense: 1 }, visual: 'feet_road', playerVisual: 'feet_starter_revised', value: 5, playerEquipReady: true, npcOnly: false, animationClass: 'full_combo', presentation: PLAYER_GEAR_PRESENTATION },
