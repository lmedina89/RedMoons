export const ITEM_DEFS = Object.freeze({
  ...
  weapon_arming_sword: { id: 'weapon_arming_sword', name: 'Ashen Arming Sword', slot: 'weapon', tags: ['weapon', 'sword', 'player_ready'], levelReq: 1, requirements: {}, baseStats: { attack: 4 }, visual: 'weapon_arming_sword', value: 18, combatProfile: 'sword_four_hit', playerCombatReady: true, playerEquipReady: true, animationClass: 'full_combo' },
  ...
  head_iron_revised: { id: 'head_iron_revised', name: 'Iron War Helm', slot: 'head', tags: ['armor', 'metal', 'revised_combat'], levelReq: 4, requirements: { str: 9 }, baseStats: { defense: 4 }, visual: 'head_iron_revised', value: 58, playerEquipReady: true, animationClass: 'full_combo' },
  ...
  chest_legion: { id: 'chest_legion', name: 'Legion Cuirass', slot: 'chest', tags: ['armor', 'metal', 'revised_combat'], levelReq: 5, requirements: { str: 11 }, baseStats: { defense: 7, maxHp: 12 }, visual: 'chest_legion', value: 92, playerEquipReady: true, animationClass: 'full_combo' },
  ...
  hands_legion: { id: 'hands_legion', name: 'Legion Gloves', slot: 'hands', tags: ['armor', 'metal', 'revised_combat'], levelReq: 4, requirements: { str: 9 }, baseStats: { defense: 3, attack: 1 }, visual: 'hands_legion', value: 48, playerEquipReady: true, animationClass: 'full_combo' },
  ...
  wings_red_bat: { id: 'wings_red_bat', name: 'Crimson Bat Wings', slot: 'wings', tags: ['wings', 'prestige', 'revised_combat'], levelReq: 1, requirements: {}, equipGate: 'wingsUnlocked', gateLabel: 'Ascendant wing attunement', baseStats: { defense: 3, maxHp: 25, moveSpeed: 6 }, visual: 'wings_red_bat', value: 250, playerEquipReady: true, animationClass: 'full_combo' },
