// v0.1.4.1 world data: Cinder Refuge is now its own deliberately composed
...
export const SPAWN_REGIONS = Object.freeze([
  { id: 'spawn_cinder_imp_south', mapId: 'map_cinder_wilds', areaId: 'area_ashen_causeway', enemyId: 'enemy_cinder_imp', x: 650, y: 700, width: 390, height: 520, count: 4, respawnMs: 6500 },
  { id: 'spawn_blight_imp_north', mapId: 'map_cinder_wilds', areaId: 'area_emberfields', enemyId: 'enemy_blight_imp', x: 1350, y: 170, width: 470, height: 330, count: 3, respawnMs: 7000 },
  { id: 'spawn_goblin_north', mapId: 'map_cinder_wilds', areaId: 'area_emberfields', enemyId: 'enemy_ash_goblin', x: 2050, y: 250, width: 500, height: 370, count: 3, respawnMs: 7600 },
  { id: 'spawn_cave_spider_south', mapId: 'map_cinder_wilds', areaId: 'area_cinderwood', enemyId: 'enemy_cave_spider', x: 1450, y: 1390, width: 470, height: 430, count: 3, respawnMs: 7200 },
  { id: 'spawn_carrion_mid', mapId: 'map_cinder_wilds', areaId: 'area_fallen_watch', enemyId: 'enemy_carrion_beast', x: 4250, y: 550, width: 250, height: 300, count: 3, respawnMs: 8000 },
  { id: 'spawn_rotwing_south', mapId: 'map_cinder_wilds', areaId: 'area_ashgrave_hollow', enemyId: 'enemy_rotwing_ravager', x: 4390, y: 1320, width: 430, height: 380, count: 2, respawnMs: 9200 },
  { id: 'spawn_blueflame_edge', mapId: 'map_cinder_wilds', areaId: 'area_ashgrave_hollow', enemyId: 'enemy_blueflame_imp', x: 4930, y: 1490, width: 380, height: 330, count: 2, respawnMs: 9800 },
  { id: 'spawn_ember_spider_edge', mapId: 'map_cinder_wilds', areaId: 'area_fallen_watch', enemyId: 'enemy_ember_spider', x: 5350, y: 300, width: 180, height: 280, count: 2, respawnMs: 9800 },
  { id: 'spawn_skeleton_edge', mapId: 'map_cinder_wilds', areaId: 'area_ashgrave_hollow', enemyId: 'enemy_ash_skeleton', x: 5200, y: 1200, width: 300, height: 410, count: 2, respawnMs: 9400 },

  { id: 'spawn_skeleton_spearman', mapId: 'map_cinder_wilds', areaId: 'area_bone_road', enemyId: 'enemy_skeleton_spearman', x: 5660, y: 1320, width: 250, height: 300, count: 1, respawnMs: 11800 },
  { id: 'spawn_skeleton_archer', mapId: 'map_cinder_wilds', areaId: 'area_bone_road', enemyId: 'enemy_skeleton_archer', x: 5700, y: 780, width: 260, height: 320, count: 1, respawnMs: 11200 },
  { id: 'spawn_skeleton_mage', mapId: 'map_cinder_wilds', areaId: 'area_bone_road', enemyId: 'enemy_skeleton_mage', x: 5950, y: 360, width: 250, height: 300, count: 1, respawnMs: 13200 },
  { id: 'spawn_slate_road', mapId: 'map_cinder_wilds', areaId: 'area_bone_road', enemyId: 'enemy_slate_revenant', x: 5650, y: 180, width: 280, height: 420, count: 2, respawnMs: 10800 },
  { id: 'spawn_bloodbone_road', mapId: 'map_cinder_wilds', areaId: 'area_bone_road', enemyId: 'enemy_bloodbone', x: 5940, y: 1040, width: 250, height: 380, count: 2, respawnMs: 12200 },
  { id: 'spawn_gilded_guard', mapId: 'map_cinder_wilds', areaId: 'area_bone_road', enemyId: 'enemy_gilded_guard', x: 6110, y: 280, width: 220, height: 320, count: 1, respawnMs: 15500 },
  { id: 'spawn_paleweb_road', mapId: 'map_cinder_wilds', areaId: 'area_bone_road', enemyId: 'enemy_frost_spider', x: 5680, y: 1610, width: 250, height: 280, count: 1, respawnMs: 13000 },
  { id: 'spawn_ashstone_golem', mapId: 'map_cinder_wilds', areaId: 'area_bone_road', enemyId: 'enemy_ashstone_golem', x: 6070, y: 1510, width: 240, height: 260, count: 1, respawnMs: 22000 },
  { id: 'spawn_captain', mapId: 'map_cinder_wilds', areaId: 'area_bone_road', enemyId: 'enemy_bone_captain', x: 6200, y: 930, width: 100, height: 130, count: 1, respawnMs: 24000 },

  { id: 'spawn_hollow_cave_spider', mapId: 'map_ashfall_hollow', areaId: 'area_ashfall_hollow', enemyId: 'enemy_cave_spider', x: 120, y: 100, width: 420, height: 430, count: 3, respawnMs: 7600 },
  { id: 'spawn_hollow_mire_spider', mapId: 'map_ashfall_hollow', areaId: 'area_ashfall_hollow', enemyId: 'enemy_mire_spider', x: 515, y: 120, width: 390, height: 390, count: 2, respawnMs: 9800 }
]);
