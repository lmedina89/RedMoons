...
export const MONSTER_FAMILY_DEFS = Object.freeze({
  ...
  demon: Object.freeze({ id: 'demon', name: 'Demon Legion', ecology: 'infernal_military', roles: ['scout', 'vanguard', 'elite'] }),
...
export const ENCOUNTER_DEFS = Object.freeze({
  ...
  enc_firstlight_demon_patrol: Object.freeze({ id: 'enc_firstlight_demon_patrol', areaId: 'area_first_light_scar', archetype: 'patrol', label: 'Ashwing Recon Patrol', alertRadius: 330, activationRange: 1050 }),
